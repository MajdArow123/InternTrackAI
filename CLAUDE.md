...
- Run: `dotnet test InternTrackAI.sln`. Current count: **542 tests, all passing** (2026-09-15, ~19 s; the 3 `PostgresMigrationTests` are no-ops unless `INTERNTRACK_PG_CONNECTION` is set). CI runs the same on every push/PR to `main`.
